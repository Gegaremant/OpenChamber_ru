...
export const linearIntegrationI18n = {
  ...
  ru: {
    'settings.integrations.github.title': 'GitHub',
    'settings.integrations.github.description': 'Подключите учетную запись GitHub для pull request-ов и задач.',
    ...
    'settings.integrations.firstParty.info': 'Вход в сервисы, поставляемые с OpenChamber. Логин хранится на этом компьютере, поэтому он доступен для веб-версии, настольного приложения и сопряженного телефона.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Подключите рабочие области Linear на этом сервере OpenChamber.',
    'settings.integrations.linear.info': 'Подключите одну или несколько рабочих областей Linear. OpenChamber хранит логины на этом компьютере, поэтому они доступны через веб-версию, настольное приложение и сопряженный телефон.',
    ...
    'settings.integrations.linear.label.otherWorkspaces': 'Другие рабочие области',
    'settings.integrations.linear.flow.title': 'Ожидание подключения Linear',
    ...
    'settings.integrations.linear.toast.connected': 'Linear подключен',
    'settings.integrations.linear.toast.disconnected': 'Linear отключен',
    ...
    'settings.integrations.linear.mapping.defaultProject.info': 'Новые сессии из задач Linear используют этот проект, если у команды-владельца задачи нет собственного сопоставления.',
    ...
    'settings.integrations.linear.mapping.teams.info': 'Необязательно. Здесь вместо стандартного проекта открывается задача от сопоставленной команды.',
    ...
    'settings.integrations.linear.mapping.emptyProjects': 'Сначала добавьте проект, а затем сопоставьте с ним команды Linear.',
    ...
    'settings.integrations.linear.sessionComments.info': 'Добавляет комментарий к задаче при запуске, завершении или сбое сессии. Комментарии публикуются только в том случае, если у этого сервера есть публичный адрес, поэтому ссылка открывает сессию для всех участников задачи.',
    'settings.integrations.linear.sessionComments.aria': 'Публиковать комментарии о статусе сессии в Linear',
    ...
    'settings.magicPrompts.page.group.linearIssueReview.description': 'Подсказки, используемые при запуске сессии из задачи Linear: видимое сообщение пользователя + скрытые инструкции.',
  },
  uk: {
    'settings.integrations.github.title': 'GitHub',
