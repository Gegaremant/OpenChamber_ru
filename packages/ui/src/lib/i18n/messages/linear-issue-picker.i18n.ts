...
export const linearIssuePickerI18n = {
  ...
  ru: {
    ...
    'chat.chatInput.linked.linearIssue.removeAria': 'Убрать привязанную задачу Linear',
    'session.linearIssuePicker.title': 'Привязать задачу Linear',
    'session.linearIssuePicker.description': 'Выберите задачу из подключенной рабочей области Linear.',
    'session.linearIssuePicker.searchPlaceholder': 'Поиск по названию, идентификатору или URL Linear',
    'session.linearIssuePicker.empty.notConnected': 'Linear не подключен. Подключите его в Настройках → Интеграции.',
    ...
    'session.linearIssuePicker.description.createSession': 'Создает сессию в проекте, сопоставленном с этой командой Linear, с задачей в качестве первого запроса.',
    'session.linearIssuePicker.error.noMappedProject': 'Сопоставьте эту команду Linear с проектом в Настройках → Интеграции.',
