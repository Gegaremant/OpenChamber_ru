...
export const linearPanelI18n = {
  ...
  ru: {
    'contextPanel.mode.linear': 'Linear',
    'contextRail.surface.linear.description': 'Просматривайте задачи Linear, изменяйте статус и запускайте сессию',
    'contextPanel.linear.actions.backToList': 'Вернуться к задачам',
    ...
    'contextPanel.linear.filter.status.completed': 'Завершено',
    ...
    'contextPanel.linear.empty.noDescription': 'Без описания',
    'contextPanel.linear.empty.noComments': 'Без комментариев',
    ...
    'contextPanel.linear.toast.statusUpdated': 'Статус задачи обновлен',
    ...
    'contextPanel.linear.error.noCompletedState': 'У этой команды нет статуса «Завершено»',
  },
  uk: {
    'contextPanel.mode.linear': 'Linear',
