...
export const thirdPartyIntegrationI18n = {
  ...
  ru: {
    ...
    'settings.integrations.thirdParty.status.installedVersion': 'Установлен {version}',
    ...
    'settings.integrations.thirdParty.dialog.remove.description': 'Удалить {name} из вашей пользовательской конфигурации OpenCode? Поставщик больше не будет загружаться после обновления OpenCode.',
    'settings.integrations.thirdParty.toast.installed': '{name} установлен',
